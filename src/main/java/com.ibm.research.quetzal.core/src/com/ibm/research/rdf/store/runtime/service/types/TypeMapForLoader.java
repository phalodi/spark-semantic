...
public class TypeMapForLoader extends TypeMap {
	...
	public static void dump() {
		/*
		here they are adding the values that are default :
		Example :
		NONE_ID 10000
		BLANK_NODE_ID 10001
		IRI_ID 10002
		SIMPLE_LITERAL_ID 5001
		...
		* */
		...
		// now print the table
		// here they are adding the primitive type for the tables i.e string , boolean etc with their respected URI's
		for(String typeIRI : typeTable.keySet()) {
			System.out.println(typeIRI + " " + typeTable.get(typeIRI));
		}

		/*
		Here the values for the Country is defined as per our understanding like US-EN , SN etc
		 */
		...
		//This total logic generates a file '<filename.nt>.types'
	}
}
